...
#define ABILITY_PROTOSYNTHESIS 0x48 //Was Vital Spirit
#define ABILITY_QUARKDRIVE 0x49 //Was White Smoke
...
#define ABILITY_SOLIDROCK 0x64 //Also Filter
#define ABILITY_FULLMETALBODY 0x65 //Was Filter
...
#define ABILITY_MOXIE 0x76 //Also Chilling Neigh
#define ABILITY_AFTERMATH 0x77
#define ABILITY_CURSEDBODY 0x78
#define ABILITY_GOOEY 0x79 //Also Tangling Hair
#define ABILITY_MUMMY 0x7A //Also Lingering Aroma
#define ABILITY_GRIMNEIGH 0x7B //was Iron Barbs
...
#define ABILITY_QUICKDRAW 0x99 //Was Turboblaze
#define ABILITY_CURIOUSMEDICINE 0x9A //Was Teravolt
...
#define ABILITY_ASONE_CHILLING 0xAF //Was Tangling Hair
...
#define ABILITY_QUEENLYMAJESTY 0xDB //Also Dazzling, Armor Tail
#define ABILITY_INNARDSOUT 0xDC
#define ABILITY_ASONE_GRIM 0xDD //Was Dazzling
...
#define ABILITY_MYCELIUMMIGHT 0xEB //Was Power of Alchemy
...
#define ABILITY_ANGERSHELL ABILITY_NONE
#define ABILITY_SEEDSOWER ABILITY_NONE
#define ABILITY_THERMALEXCHANGE ABILITY_NONE
#define ABILITY_PURIFYINGSALT ABILITY_NONE
#define ABILITY_WELLBAKEDBODY ABILITY_NONE
#define ABILITY_WINDRIDER ABILITY_NONE
#define ABILITY_GUARDDOG ABILITY_NONE
#define ABILITY_ROCKYPAYLOAD ABILITY_NONE
#define ABILITY_WINDPOWER ABILITY_NONE
#define ABILITY_ZEROTOHERO ABILITY_NONE
#define ABILITY_COMMANDER ABILITY_NONE
#define ABILITY_ELECTROMORPHOSIS ABILITY_NONE
#define ABILITY_GOODASGOLD ABILITY_NONE
#define ABILITY_VESSELOFRUIN ABILITY_NONE
#define ABILITY_SWORDOFRUIN ABILITY_NONE
#define ABILITY_TABLETSOFRUIN ABILITY_NONE
#define ABILITY_BEADSOFRUIN ABILITY_NONE
#define ABILITY_ORICHALCUMPULSE ABILITY_NONE
#define ABILITY_HADRONENGINE ABILITY_NONE
#define ABILITY_OPPORTUNIST ABILITY_NONE
#define ABILITY_CUDCHEW ABILITY_NONE
#define ABILITY_SHARPNESS ABILITY_NONE
#define ABILITY_SUPREMEOVERLORD ABILITY_NONE
#define ABILITY_COSTAR ABILITY_NONE
#define ABILITY_TOXICDEBRIS ABILITY_NONE
#define ABILITY_EARTHEATER ABILITY_NONE
#define ABILITY_MINDSEYE ABILITY_NONE
#define ABILITY_SUPERSWEETSYRUP ABILITY_NONE
#define ABILITY_HOSPITALITY ABILITY_NONE
#define ABILITY_TOXICCHAIN ABILITY_NONE
#define ABILITY_EMBODYASPECT ABILITY_NONE
#define ABILITY_TERASHIFT ABILITY_NONE
#define ABILITY_TERASHELL ABILITY_NONE
#define ABILITY_TERAFORMZERO ABILITY_NONE
#define ABILITY_POISONPUPPETEER ABILITY_NONE

#define ABILITIES_COUNT (ABILITY_UNSEENFIST + 1)
