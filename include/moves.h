...
#define MOVE_STOKED_SPARKSURFER 0x31E			//Paralyze Target
#define MOVE_EXTREME_EVOBOOST 0x31F			//Double Ancient Power
#define MOVE_PULVERIZING_PANCAKE 0x320
#define MOVE_GENESIS_SUPERNOVA 0x321			//Sets up Psychic Terrain
#define MOVE_SINISTER_ARROW_RAID 0x322
#define MOVE_MALICIOUS_MOONSAULT 0x323
#define MOVE_OCEANIC_OPERETTA 0x324
#define MOVE_SPLINTERED_STORMSHARDS 0x325		//Removes Terrain
#define MOVE_LETS_SNUGGLE_FOREVER 0x326
#define MOVE_CLANGOROUS_SOULBLAZE 0x327			//Ancient Power
...
//nothing defined under 0x360 by mistake, fix later
#define MOVE_G_MAX_TERROR_P 0x361
#define MOVE_G_MAX_TERROR_S 0x362
#define MOVE_G_MAX_FOAM_BURST_P 0x363
#define MOVE_G_MAX_FOAM_BURST_S 0x364
#define MOVE_G_MAX_RESONANCE_P 0x365
#define MOVE_G_MAX_RESONANCE_S 0x366
#define MOVE_G_MAX_CUDDLE_P 0x367
#define MOVE_G_MAX_CUDDLE_S 0x368
#define MOVE_G_MAX_REPLENISH_P 0x369
#define MOVE_G_MAX_REPLENISH_S 0x36A
#define MOVE_G_MAX_MALODOR_P 0x36B
#define MOVE_G_MAX_MALODOR_S 0x36C
#define MOVE_G_MAX_MELTDOWN_P 0x36D
#define MOVE_G_MAX_MELTDOWN_S 0x36E
#define MOVE_G_MAX_DRUM_SOLO_P 0x36F
#define MOVE_G_MAX_DRUM_SOLO_S 0x370
#define MOVE_G_MAX_FIREBALL_P 0x371
#define MOVE_G_MAX_FIREBALL_S 0x372
#define MOVE_G_MAX_HYDROSNIPE_P 0x373
#define MOVE_G_MAX_HYDROSNIPE_S 0x374
#define MOVE_G_MAX_WIND_RAGE_P 0x375
#define MOVE_G_MAX_WIND_RAGE_S 0x376
#define MOVE_G_MAX_GRAVITAS_P 0x377
#define MOVE_G_MAX_GRAVITAS_S 0x378
#define MOVE_G_MAX_STONESURGE_P 0x379
#define MOVE_G_MAX_STONESURGE_S 0x37A
#define MOVE_G_MAX_VOLCALITH_P 0x37B
#define MOVE_G_MAX_VOLCALITH_S 0x37C
#define MOVE_G_MAX_TARTNESS_P 0x37D
#define MOVE_G_MAX_TARTNESS_S 0x37E
#define MOVE_G_MAX_SWEETNESS_P 0x37F
#define MOVE_G_MAX_SWEETNESS_S 0x380
#define MOVE_G_MAX_SANDBLAST_P 0x381
#define MOVE_G_MAX_SANDBLAST_S 0x382
#define MOVE_G_MAX_STUN_SHOCK_P 0x383
#define MOVE_G_MAX_STUN_SHOCK_S 0x384
#define MOVE_G_MAX_CENTIFERNO_P 0x385
#define MOVE_G_MAX_CENTIFERNO_S 0x386
#define MOVE_G_MAX_SMITE_P 0x387
#define MOVE_G_MAX_SMITE_S 0x388
#define MOVE_G_MAX_SNOOZE_P 0x389
#define MOVE_G_MAX_SNOOZE_S 0x38A
#define MOVE_G_MAX_FINALE_P 0x38B
#define MOVE_G_MAX_FINALE_S 0x38C
#define MOVE_G_MAX_STEELSURGE_P 0x38D
#define MOVE_G_MAX_STEELSURGE_S 0x38E
#define MOVE_G_MAX_DEPLETION_P 0x38F
#define MOVE_G_MAX_DEPLETION_S 0x390
#define MOVE_G_MAX_ONE_BLOW_P 0x391
#define MOVE_G_MAX_ONE_BLOW_S 0x392
#define MOVE_G_MAX_RAPID_FLOW_P 0x393
#define MOVE_G_MAX_RAPID_FLOW_S 0x394
...
#define NON_Z_MOVE_COUNT   (MOVE_POT_SMASH + 1)