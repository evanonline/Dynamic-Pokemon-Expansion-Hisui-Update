...
#define MOVE_COLLISIONCOURSE 0x31C
#define MOVE_ELECTRODRIFT 0x31D
#define MOVE_SHEDTAIL 0x31E
#define MOVE_CHILLYRECEPTION 0x31F
#define MOVE_TIDYUP 0x320
#define MOVE_POUNCE 0x321
#define MOVE_TRAILBLAZE 0x322
#define MOVE_CHILLINGWATER 0x323
#define MOVE_KOWTOWCLEAVE 0x324
#define MOVE_HYPERDRILL 0x325
#define MOVE_TWINBEAM 0x326
#define MOVE_RAGEFIST 0x327
#define MOVE_GIGATONHAMMER 0x328
#define MOVE_ARMORCANNON 0x329
#define MOVE_BITTERBLADE 0x32A
#define MOVE_DOUBLESHOCK 0x32B
#define MOVE_COMEUPPANCE 0x32C
#define MOVE_AQUACUTTER 0x32D
#define MOVE_BLOODMOON 0x32E
#define MOVE_MATCHAGOTCHA 0x32F
#define MOVE_SYRUPBOMB 0x330
#define MOVE_FICKLEBEAM 0x331
#define MOVE_DRAGONCHEER 0x332
#define MOVE_ELECTROSHOT 0x333
#define MOVE_BURNINGBULWARK 0x334
#define MOVE_THUNDERCLAP 0x335
#define MOVE_TACHYONCUTTER 0x336
#define MOVE_HARDPRESS 0x337
#define MOVE_MIGHTYCLEAVE 0x338
#define MOVE_ALLURINGVOICE 0x339
#define MOVE_TEMPERFLARE 0x33A
#define MOVE_SUPERCELLSLAM 0x33B
#define MOVE_PSYCHICNOISE 0x33C
#define MOVE_UPPERHAND 0x33D
#define MOVE_MALIGNANTCHAIN 0x33E
#define MOVE_ORDERUP 0x33F //Dondozo's signature, related to Tatsugiri in doubles
#define MOVE_IVYCUDGEL 0x340 //Ogerpon signature
#define MOVE_TERABLAST 0x341 //Basically relies on Tera mechanics to be implemented
#define MOVE_TERASTARSTORM 0x342 //Terapagos move, may not be able to implement
