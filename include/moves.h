...
#define MOVE_SNOWSCAPE 0x102 //Replaces Hail
...
//PLA Moves part 1
#define MOVE_BARBBARRAGE 0x2E7
#define MOVE_WAVECRASH 0x2E8
#define MOVE_PSYSHIELDBASH 0x2E9
#define MOVE_DIRECLAW 0x2EA
#define MOVE_INFERNALPARADE 0x2EB
#define MOVE_CEASELESSEDGE 0x2EC
#define MOVE_TRIPLEARROWS 0x2ED
#define MOVE_STONEAXE 0x2EE
#define MOVE_MOUNTAINGALE 0x2EF
#define MOVE_ESPERWING 0x2F0
#define MOVE_CHLOROBLAST 0x2F1
#define MOVE_BITTERMALICE 0x2F2

//Mint's attacks - if you're looking at this code, you can ignore these, this is only relevant for my own personal romhack
#define MOVE_SCRUNCH 0x2F3
#define MOVE_JAB 0x2F4
#define MOVE_SPECIALPUNCH 0x2F5
#define MOVE_LEEKSLAP 0x2F6
#define MOVE_POTSMASH 0x2F7

//PLA Moves part 2

#define MOVE_SPRINGTIDESTORM 0x2F8
#define MOVE_BLEAKWINDSTORM 0x2F9
#define MOVE_WILDBOLTSTORM 0x2FA
#define MOVE_SANDSEARSTORM 0x2FB
#define MOVE_RAGINGFURY 0x2FC
#define MOVE_POWERSHIFT 0x2FD
#define MOVE_HEADLONGRUSH 0x2FE
#define MOVE_SHELTER 0x2FF
#define MOVE_LUNARBLESSING 0x300
#define MOVE_VICTORYDANCE 0x301
#define MOVE_MYSTICALPOWER 0x302
#define MOVE_TAKEHEART 0x303

//Scarlet & Violet moves

#define MOVE_SILKTRAP 0x304
#define MOVE_AXEKICK 0x305
#define MOVE_LASTRESPECTS 0x306
#define MOVE_LUMINACRASH 0x307
#define MOVE_JETPUNCH 0x308
#define MOVE_SPICYEXTRACT 0x309
#define MOVE_SPINOUT 0x30A
#define MOVE_POPULATIONBOMB 0x30B
#define MOVE_ICESPINNER 0x30C 
#define MOVE_GLAIVERUSH 0x30D
#define MOVE_REVIVALBLESSING 0x30E
#define MOVE_SALTCURE 0x30F
#define MOVE_TRIPLEDIVE 0x310
#define MOVE_MORTALSPIN 0x311
#define MOVE_DOODLE 0x312
#define MOVE_FILLETAWAY 0x313
#define MOVE_FLOWERTRICK 0x314
#define MOVE_TORCHSONG 0x315
#define MOVE_AQUASTEP 0x316
#define MOVE_RAGINGBULL 0x317
#define MOVE_MAKEITRAIN 0x318
#define MOVE_PSYBLADE 0x319
#define MOVE_RUINATION 0x31A
#define MOVE_HYDROSTEAM 0x31B
#define MOVE_PSYBLADE 0x31C
#define MOVE_COLLISIONCOURSE 0x31D
#define MOVE_ELECTRODRIFT 0x31E
#define MOVE_SHEDTAIL 0x31F
#define MOVE_CHILLYRECEPTION 0x320
#define MOVE_TIDYUP 0x321
#define MOVE_POUNCE 0x322
#define MOVE_TRAILBLAZE 0x323
#define MOVE_CHILLINGWATER 0x324
#define MOVE_KOWTOWCLEAVE 0x325
#define MOVE_HYPERDRILL 0x326
#define MOVE_TWINBEAM 0x327
#define MOVE_RAGEFIST 0x328
#define MOVE_GIGATONHAMMER 0x329
#define MOVE_ARMORCANNON 0x32A
#define MOVE_BITTERBLADE 0x32B
#define MOVE_DOUBLESHOCK 0x32C
#define MOVE_COMEUPPANCE 0x32D
#define MOVE_AQUACUTTER 0x32E
#define MOVE_BLOODMOON 0x32F
#define MOVE_MATCHAGOTCHA 0x330
#define MOVE_SYRUPBOMB 0x331
#define MOVE_FICKLEBEAM 0x332
#define MOVE_DRAGONCHEER 0x333
#define MOVE_ELECTROSHOT 0x334
#define MOVE_BURNINGBULWARK 0x335
#define MOVE_THUNDERCLAP 0x336
#define MOVE_TACHYONCUTTER 0x337
#define MOVE_HARDPRESS 0x338
#define MOVE_MIGHTYCLEAVE 0x339
#define MOVE_ALLURINGVOICE 0x33A
#define MOVE_TEMPERFLARE 0x33B
#define MOVE_SUPERCELLSLAM 0x33C
#define MOVE_PSYCHICNOISE 0x33D
#define MOVE_UPPERHAND 0x33E
#define MOVE_MALIGNANTCHAIN 0x33F
#define MOVE_ORDERUP 0x340 //Dondozo's signature, related to Tatsugiri in doubles
#define MOVE_IVYCUDGEL 0x341 //Ogerpon signature
#define MOVE_TERABLAST 0x342  //Basically relies on Tera mechanics to be implemented
#define MOVE_TERASTARSTORM 0x343 //Terapagos move, may not be able to implement

//Note to self - Hail is replaced by Snowscape

//Z-Moves
#define MOVE_BREAKNECK_BLITZ_P 0x344
#define MOVE_BREAKNECK_BLITZ_S 0x345
#define MOVE_ALL_OUT_PUMMELING_P 0x346
#define MOVE_ALL_OUT_PUMMELING_S 0x347
#define MOVE_SUPERSONIC_SKYSTRIKE_P 0x348
#define MOVE_SUPERSONIC_SKYSTRIKE_S 0x349
#define MOVE_ACID_DOWNPOUR_P 0x34A
#define MOVE_ACID_DOWNPOUR_S 0x34B
#define MOVE_TECTONIC_RAGE_P 0x34C
#define MOVE_TECTONIC_RAGE_S 0x34D
#define MOVE_CONTINENTAL_CRUSH_P 0x34E
#define MOVE_CONTINENTAL_CRUSH_S 0x34F
#define MOVE_SAVAGE_SPIN_OUT_P 0x350
#define MOVE_SAVAGE_SPIN_OUT_S 0x351
#define MOVE_NEVER_ENDING_NIGHTMARE_P 0x352
#define MOVE_NEVER_ENDING_NIGHTMARE_S  0x353
#define MOVE_CORKSCREW_CRASH_P 0x354
#define MOVE_CORKSCREW_CRASH_S 0x355
#define MOVE_INFERNO_OVERDRIVE_P 0x356
#define MOVE_INFERNO_OVERDRIVE_S 0x357
#define MOVE_HYDRO_VORTEX_P 0x358
#define MOVE_HYDRO_VORTEX_S 0x359 
#define MOVE_BLOOM_DOOM_P 0x35A
#define MOVE_BLOOM_DOOM_S 0x35B
#define MOVE_GIGAVOLT_HAVOC_P 0x35C
#define MOVE_GIGAVOLT_HAVOC_S 0x35D
#define MOVE_SHATTERED_PSYCHE_P 0x35E
#define MOVE_SHATTERED_PSYCHE_S 0x35F
#define MOVE_SUBZERO_SLAMMER_P 0x360
#define MOVE_SUBZERO_SLAMMER_S 0x361
#define MOVE_DEVASTATING_DRAKE_P 0x362
#define MOVE_DEVASTATING_DRAKE_S 0x363
#define MOVE_BLACK_HOLE_ECLIPSE_P 0x364
#define MOVE_BLACK_HOLE_ECLIPSE_S 0x365
#define MOVE_TWINKLE_TACKLE_P  0x366
#define MOVE_TWINKLE_TACKLE_S 0x367

#define MOVE_CATASTROPIKA 0x368
#define MOVE_10000000_VOLT_THUNDERBOLT 0x369
#define MOVE_STOKED_SPARKSURFER 0x36A			//Paralyze Target
#define MOVE_EXTREME_EVOBOOST 0x36B		//Double Ancient Power
#define MOVE_PULVERIZING_PANCAKE 0x36C
#define MOVE_GENESIS_SUPERNOVA 0x36D			//Sets up Psychic Terrain
#define MOVE_SINISTER_ARROW_RAID 0x36E
#define MOVE_MALICIOUS_MOONSAULT 0x36F
#define MOVE_OCEANIC_OPERETTA 0x370
#define MOVE_SPLINTERED_STORMSHARDS 0x371		//Removes Terrain
#define MOVE_LETS_SNUGGLE_FOREVER 0x372
#define MOVE_CLANGOROUS_SOULBLAZE 0x373			//Ancient Power
#define MOVE_GUARDIAN_OF_ALOLA 0x374
#define MOVE_SEARING_SUNRAZE_SMASH 0x375
#define MOVE_MENACING_MOONRAZE_MAELSTROM 0x376
#define MOVE_LIGHT_THAT_BURNS_THE_SKY 0x377
#define MOVE_SOUL_STEALING_7_STAR_STRIKE 0x378

#define FIRST_Z_MOVE        MOVE_BREAKNECK_BLITZ_P
#define LAST_Z_MOVE         MOVE_SOUL_STEALING_7_STAR_STRIKE

//Max Moves
#define MOVE_MAX_GUARD 0x379
#define MOVE_MAX_STRIKE_P 0x37A
#define MOVE_MAX_STRIKE_S 0x37B
#define MOVE_MAX_KNUCKLE_P 0x37C
#define MOVE_MAX_KNUCKLE_S 0x37D
#define MOVE_MAX_AIRSTREAM_P 0x37E
#define MOVE_MAX_AIRSTREAM_S 0x37F
#define MOVE_MAX_OOZE_P 0x380
#define MOVE_MAX_OOZE_S 0x381
#define MOVE_MAX_QUAKE_P 0x382
#define MOVE_MAX_QUAKE_S 0x383 
#define MOVE_MAX_ROCKFALL_P 0x384
#define MOVE_MAX_ROCKFALL_S 0x385
#define MOVE_MAX_FLUTTERBY_P 0x386
#define MOVE_MAX_FLUTTERBY_S 0x387
#define MOVE_MAX_PHANTASM_P 0x388
#define MOVE_MAX_PHANTASM_S 0x389
#define MOVE_MAX_STEELSPIKE_P 0x38A
#define MOVE_MAX_STEELSPIKE_S 0x38B
#define MOVE_MAX_FLARE_P 0x38C
#define MOVE_MAX_FLARE_S 0x38D
#define MOVE_MAX_GEYSER_P 0x38E
#define MOVE_MAX_GEYSER_S 0x38F
#define MOVE_MAX_OVERGROWTH_P 0x390
#define MOVE_MAX_OVERGROWTH_S 0x391
#define MOVE_MAX_LIGHTNING_P 0x392
#define MOVE_MAX_LIGHTNING_S 0x393
#define MOVE_MAX_MINDSTORM_P 0x394
#define MOVE_MAX_MINDSTORM_S 0x395
#define MOVE_MAX_HAILSTORM_P 0x396
#define MOVE_MAX_HAILSTORM_S 0x397
#define MOVE_MAX_WYRMWIND_P 0x398
#define MOVE_MAX_WYRMWIND_S 0x399
#define MOVE_MAX_DARKNESS_P 0x39A
#define MOVE_MAX_DARKNESS_S 0x39B
#define MOVE_MAX_STARFALL_P 0x39C
#define MOVE_MAX_STARFALL_S 0x39D
#define MOVE_G_MAX_VINE_LASH_P 0x39E
#define MOVE_G_MAX_VINE_LASH_S 0x39F
#define MOVE_G_MAX_WILDFIRE_P 0x400
#define MOVE_G_MAX_WILDFIRE_S 0x401
#define MOVE_G_MAX_CANNONADE_P 0x402
#define MOVE_G_MAX_CANNONADE_S 0x403
#define MOVE_G_MAX_BEFUDDLE_P 0x404
#define MOVE_G_MAX_BEFUDDLE_S 0x405
#define MOVE_G_MAX_VOLT_CRASH_P 0x406
#define MOVE_G_MAX_VOLT_CRASH_S 0x407
#define MOVE_G_MAX_GOLD_RUSH_P 0x408
#define MOVE_G_MAX_GOLD_RUSH_S 0x409
#define MOVE_G_MAX_CHI_STRIKE_P 0x40A
#define MOVE_G_MAX_CHI_STRIKE_S 0x40B
#define MOVE_G_MAX_TERROR_P 0x40C
#define MOVE_G_MAX_TERROR_S 0x40D
#define MOVE_G_MAX_FOAM_BURST_P 0x40E
#define MOVE_G_MAX_FOAM_BURST_S 0x40F
#define MOVE_G_MAX_RESONANCE_P 0x410
#define MOVE_G_MAX_RESONANCE_S 0x411
#define MOVE_G_MAX_CUDDLE_P 0x412
#define MOVE_G_MAX_CUDDLE_S 0x413
#define MOVE_G_MAX_REPLENISH_P 0x414
#define MOVE_G_MAX_REPLENISH_S 0x415
#define MOVE_G_MAX_MALODOR_P 0x416
#define MOVE_G_MAX_MALODOR_S 0x417
#define MOVE_G_MAX_MELTDOWN_P 0x418
#define MOVE_G_MAX_MELTDOWN_S 0x419
#define MOVE_G_MAX_DRUM_SOLO_P 0x41A
#define MOVE_G_MAX_DRUM_SOLO_S 0x41B
#define MOVE_G_MAX_FIREBALL_P 0x41C
#define MOVE_G_MAX_FIREBALL_S 0x41D
#define MOVE_G_MAX_HYDROSNIPE_P 0x41E
#define MOVE_G_MAX_HYDROSNIPE_S 0x41F
#define MOVE_G_MAX_WIND_RAGE_P 0x420
#define MOVE_G_MAX_WIND_RAGE_S 0x421
#define MOVE_G_MAX_GRAVITAS_P 0x422
#define MOVE_G_MAX_GRAVITAS_S 0x423
#define MOVE_G_MAX_STONESURGE_P 0x424
#define MOVE_G_MAX_STONESURGE_S 0x425
#define MOVE_G_MAX_VOLCALITH_P 0x426
#define MOVE_G_MAX_VOLCALITH_S 0x427
#define MOVE_G_MAX_TARTNESS_P 0x428
#define MOVE_G_MAX_TARTNESS_S 0x429
#define MOVE_G_MAX_SWEETNESS_P 0x42A
#define MOVE_G_MAX_SWEETNESS_S 0x42B
#define MOVE_G_MAX_SANDBLAST_P 0x42C
#define MOVE_G_MAX_SANDBLAST_S 0x42D
#define MOVE_G_MAX_STUN_SHOCK_P 0x42E
#define MOVE_G_MAX_STUN_SHOCK_S 0x42F
#define MOVE_G_MAX_CENTIFERNO_P 0x430
#define MOVE_G_MAX_CENTIFERNO_S 0x431
#define MOVE_G_MAX_SMITE_P 0x432
#define MOVE_G_MAX_SMITE_S 0x433
#define MOVE_G_MAX_SNOOZE_P 0x434
#define MOVE_G_MAX_SNOOZE_S 0x435
#define MOVE_G_MAX_FINALE_P 0x436
#define MOVE_G_MAX_FINALE_S 0x437
#define MOVE_G_MAX_STEELSURGE_P 0x438
#define MOVE_G_MAX_STEELSURGE_S 0x439
#define MOVE_G_MAX_DEPLETION_P 0x43A
#define MOVE_G_MAX_DEPLETION_S 0x43B
#define MOVE_G_MAX_ONE_BLOW_P 0x43C
#define MOVE_G_MAX_ONE_BLOW_S 0x43D
#define MOVE_G_MAX_RAPID_FLOW_P 0x43E
#define MOVE_G_MAX_RAPID_FLOW_S 0x43F
...
#define NON_Z_MOVE_COUNT   (MOVE_TERASTARSTORM + 1)