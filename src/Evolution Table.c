...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_SPEWPA] =           {{EVO_LEVEL, 12, SPECIES_VIVILLON_FANCY, 0}},
...
//evos to note
//primal dialga, alolan raichu, alolan marowak, alolan exeggutor, galarian mr. mime, galarian weezing, hisuian lilligant,
//hisuian braviary, hisuian sliggoo, hisuian avalugg, hisui decidueye/typhlosion/samurott
//melmetal, urshifu, galarian farfetch'd and yamask? alternate trade item for karrablast and shelmet
//
//"gmaxite" - will need to change gmax base stats some for this to work. Worth considering
//Not implemented but here's a template to copypaste if you do:
//
//
//{EVO_MEGA, ITEM_GMAXITE, SPECIES_x_GIGA, MEGA_VARIANT_STANDARD}
//
//
//need sinistea and polteageist antique graphics - SHOULD be drag and drop...?
//held items for PLA guys
//world cap pikachu can dynamax