...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_PETILIL_H] =          {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT_H, 0}},
	[SPECIES_BASCULIN_WHITE] =         {{EVO_MOVE, MOVE_WAVECRASH, SPECIES_BASCULEGION, 0},
	...
	[SPECIES_SCYTHER_H] =          {{EVO_ITEM, ITEM_BLACK_AUGURITE, SPECIES_KLEAVOR, 0}},
						{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR, 0},
								  {EVO_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR, 0}},
