...
const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
	...
	[SPECIES_PETILIL] =          {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT, 0},
								  {EVO_ITEM_LOCATION, ITEM_SUN_STONE, SPECIES_LILLIGANT_A, MB_SHALLOW_WATER}}, //temp location
	...
	[SPECIES_QUILAVA] =          {{EVO_TYPE_IN_PARTY, 36, SPECIES_TYPHLOSION_H, TYPE_GHOST}},
	...
	[SPECIES_DEWOTT] =           {{EVO_TYPE_IN_PARTY, 36, SPECIES_SAMUROTT_H, TYPE_DARK}},
	[SPECIES_BASCULIN_WHITE] =   {{EVO_MOVE, MOVE_WAVECRASH, SPECIES_BASCULEGION, 0 MON_MALE},
								  {EVO_MOVE, MOVE_WAVECRASH, SPECIES_BASCULEGION_FEMALE, 0 MON_FEMALE}), //unsure if "MON_FEMALE" works outside of Dawn Stone evolutions?
	[SPECIES_ZORUA_H] =          {{EVO_LEVEL, 30, SPECIES_ZOROARK_H, 0}},
	[SPECIES_RUFFLET] =          {{EVO_TYPE_IN_PARTY, 54, SPECIES_BRAVIARY_H, TYPE_PSYCHIC}},
	[SPECIES_GOOMY] =            {{EVO_TYPE_IN_PARTY, 40, SPECIES_SLIGGOO_H, TYPE_STEEL}},
	[SPECIES_SLIGGOO_H] =        {{EVO_RAINY_FOGGY_OW, 50, SPECIES_GOODRA_H, 0}},
	[SPECIES_BERGMITE] =         {{EVO_TYPE_IN_PARTY, 37, SPECIES_AVALUGG_H, TYPE_ROCK}},
	[SPECIES_DARTRIX] =          {{EVO_TYPE_IN_PARTY, 36, SPECIES_DECIDUEYE_H, TYPE_FIGHTING}},
	[SPECIES_STANTLER] =         {{EVO_MOVE, MOVE_PSYSHIELDBASH, SPECIES_WYRDEER, 0}},
	[SPECIES_URSARING_H] =       {{EVO_HOLD_ITEM_NIGHT, ITEM_PEAT_BLOCK, SPECIES_URSALUNA, 0}},
};
